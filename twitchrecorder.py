...
class TwitchRecorder:
    ...
    def send_stream_failure_notification(self, error_message):
        message = f"Stream for {self.username} has encountered an error:\n{error_message}"
